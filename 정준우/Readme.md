...
- 메인 페이지 구현 완료
  ...
  - 메인 페이지 상단 이미지에서 돌아가는 와플 그림 및 일정 시간마다 바뀌는 글자
  
  - 스크롤 정도에 따라 새로운 요소가 나타나도록 구현
  
  - 버튼 누르면 제일 위로 스크롤되도록 구현
  
  - 추후 다른 페이지들이 구현되면 버튼에 연결시켜주면 됨

- 로그인 페이지
  
  - 이메일, 비밀번호 입력 공간 구현
    
    - 포커싱 되었을 때 Placeholder가 다른 색과 크기로 변하며 위쪽으로 이동
...
- 로그인 페이지 디자인 구현 완료
  ...
  - 백엔드 로그인 구현 완료되면 연결 필요

- 회원가입 페이지 디자인 진행중

- 중간발표용 ppt 구성 완료
  
  - 내일 전체적인 색감, 글 피드백 받은 후 수정 예정

---

# 2023 / 09 / 14

- 중간 발표 PPT 피드백 받은 후 수정
  
  - 내일 발표 전 애니메이션 마지막 점검 할 예정

- 회원가입 부분 비밀번호 확인, 생년월일 구성

---

# 2023 / 09 / 18

- 회원가입 페이지 유효성 검사 구현 완료

- 이메일 찾기, 이메일 찾기 결과 페이지 생성 완료

- 내일 mySQL 연결 후 백엔드 코드를 받아 로컬에서 실행 후 프론트와 연결 예정
